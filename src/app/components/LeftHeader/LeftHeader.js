  ...
  return (
    <>
      <div className=" border-r border-[#E9EBF0]">
        <div className="flex items-center justify-between  py-[30px] px-[32px]">
        ...
        <div className={`${!modal?"flex justify-between px-8 absolute z-10  flex-col lg:static invisible w-0 opacity-0 duration-500 bg-[#F7F8FA] ":"w-full h-screen duration-500"} px-[32px] pb-[30px] transition-all lg:visible lg:w-full lg:opacity-100`}>
          <DashboardSection />
          <ProjectsSection />
        </div>
      </div>
